...
export const GeneralInstructions = ({ DASHBOARD_URL, CMS_URL }) => {
    return (
        <>
            ...
            <p className="blue-1">Trigger Details:</p>
            <ul>
                <li>
                    <p className="black-1">
                        Trigger Type:  onScroll<br />
                        Value: Define the scroll percentage (e.g., 50 for 50%).<br />
                        Description: Trigger the event when the user scrolls a certain percentage of the page.
                    </p>
                </li>
                <li>
                    <p className="black-1">
                        Trigger Type:  onLoad<br />
                        Trigger Value:  Specify the number of seconds after which the event should be triggered.<br />
                        Description: Trigger the event after given seconds when the page fully loads.
                    </p>
                </li>
                <li>
                    <p className="black-1">
                        Trigger Type:  onInactivity<br />
                        Trigger Value:  Specify the number of seconds of inactivity before the chatbot is triggered.<br />
                        Description: Trigger the event after a specified number of seconds of inactivity.
                    </p>
                </li>
            </ul>
