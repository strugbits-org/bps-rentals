          ...
          {filteredVariants.map((selectedData, index) => {
            return (
              <React.Fragment key={index}>
                ...
                >
                  <ImageWrapper defaultDimensions={{ width: 350, height: 350 }} url={selectedData.variant.imageSrc} type="product" />
                </div>
              </React.Fragment>
            );
          })}
                ...
                {idx < 4 && (
                  ...
                  >
                    <div className="container-img">
                      <ImageWrapper defaultDimensions={{ width: 40, height: 40 }} url={variant.variant.imageSrc} type="product" />
                    </div>
                  </li>
                )}
              </React.Fragment>
