...
import { reloadCartModal, resetSlideIndex, updatedWatched } from "@/Utils/AnimationFunctions";
...
const CartModal = ({
  ...
  return (
    <div>
      <modal-group ref={modalRef} name="modal-product-2" class="modal-product">
        <modal-container>
          <modal-item>
                      ...
                      >
                        ...
                        >
                          <li
                            ...
                            data-default-active
                            data-get-color={selectedVariantData?.color}
                          >
                        ...
                        <div class="container-product-description">
                          <div class="form-cart">
                            ...
                            <AvailabilityCard selectedVariantData={variantData[selectedVariantIndex]} setUnavailable={setUnavailable} />
                            {productData &&
